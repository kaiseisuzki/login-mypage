        ...
        <form action="mypage.php" method="post">
            <div class="form_contents">
                <div class="mail">
                    ...
                    <input type="text" name="mail" class="formbox" size="40" value="<?php if(isset($_COOKIE['login_keep']))
                    {echo $_COOKIE['mail']; } ?>">
                </div>
                <div class="password">
                    <label>パスワード</label><br>
                    <input type="text" name="password" id="password" class="formbox" size="40" value="<?php echo $_COOKIE['password']; ?>">
                </div>
